...
{
    zn_av_freep(&r->intra_types_hist);
    r->intra_types = NULL;
    zn_av_freep(&r->tmp_b_block_base);
    zn_av_freep(&r->mb_type);
    zn_av_freep(&r->cbp_luma);
    zn_av_freep(&r->cbp_chroma);
    zn_av_freep(&r->deblock_coefs);
}
