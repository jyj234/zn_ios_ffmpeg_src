...
{
    enum FFMAVMediaType type = ost->type;
...
static MuxStream *mux_stream_alloc(Muxer *mux, enum FFMAVMediaType type)
{
    const char *type_str = av_get_media_type_string(type);
    MuxStream *ms;
...
static int ost_add(Muxer *mux, const OptionsContext *o, enum FFMAVMediaType type,
