 ...
 * I/O functions). The filename passed to zn_avformat_open_input() often does not
...
typedef struct AVDeviceInfo {
    ...
    enum FFMAVMediaType *media_types;       /**< array indicating what media types(s), if any, a device can provide. If null, cannot provide any */
 ...
 *                         The same options must be passed later to zn_avformat_write_header() for output
 *                         devices or zn_avformat_open_input() for input devices, or at any other place
